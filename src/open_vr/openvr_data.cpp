...
openvr_data::openvr_data() {
	...
	add_input_action("primary", "analog", IT_VECTOR2);
	// add_input_action("secondary", "???", IT_VECTOR2);
	add_input_action("trigger_value", "analog_trigger", IT_FLOAT);
	add_input_action("grip_value", "analog_grip", IT_FLOAT);

	add_input_action("primary_click", "analog_click", IT_BOOL);
	// add_input_action("secondary_click", "???", IT_BOOL);
